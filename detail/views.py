...
def changdeok(request):
    ...
    chat = translator.translate(output_text).text
    title = translator.translate(posts.region).text
    return render(request, 'changdeok.html', {'result': result, 'result2': result2, 'result3': result3,
                                           'result4': result4, 'result5': result5, 'result6': result6,
                                           'posts': posts, 'output_text': output_text, 'chat': chat, 'title':title})
...
def dongdaemoon(request):
    ...
    chat = translator.translate(output_text).text
    title = translator.translate(posts.region).text
    return render(request, 'dongdaemoon.html', {'result': result, 'result2': result2, 'result3': result3,
                                           'result4': result4, 'result5': result5, 'result6': result6,
                                           'posts': posts, 'output_text': output_text, 'chat': chat, 'title':title})
...
def hangang(request):
    ...
    chat = translator.translate(output_text).text
    title = translator.translate(posts.region).text
    return render(request, 'hangang.html', {'result': result, 'result2': result2, 'result3': result3,
                                           'result4': result4, 'result5': result5, 'result6': result6,
                                           'posts': posts, 'output_text': output_text, 'chat': chat, 'title':title})
...
def seoulchurch(request):
    ...
    chat = translator.translate(output_text).text
    title = translator.translate(posts.region).text
    return render(request, 'seoulchurch.html', {'result': result, 'result2': result2, 'result3': result3,
                                           'result4': result4, 'result5': result5, 'result6': result6,
                                           'posts': posts, 'output_text': output_text, 'chat': chat, 'title':title})


def seoulpark(request):
    response = openai.ChatCompletion.create(
        model="gpt-3.5-turbo",
        messages=[
            {"role": "user", "content": "2016년 롤드컵 우승팀은 어디야?"},
    ...
    chat = translator.translate(output_text).text
    title = translator.translate(posts.region).text
    return render(request, 'seoulpark.html', {'result': result, 'result2': result2, 'result3': result3,
                                           'result4': result4, 'result5': result5, 'result6': result6,
                                           'posts': posts, 'output_text': output_text, 'chat': chat, 'title':title})
